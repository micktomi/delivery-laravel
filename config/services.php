...
return [
    ...
    */
    ...
    'viva' => [
        ...
        'reconciliation_merchant_id' => env('VIVA_RECONCILIATION_MERCHANT_ID', env('VIVA_MERCHANT_ID')),
        'reconciliation_api_key' => env('VIVA_RECONCILIATION_API_KEY', env('VIVA_API_KEY')),
    ],
